...
class Agent:
    ...
    def update_observations(self):
        ...
        # self.get_obs(self.obs.sensor_measurement_2), self.get_obs(self.obs.sensor_measurement_30)]
        # self.sensors_behind = [-self.get_obs(self.obs.sensor_measurement_16),
        # -self.get_obs(self.obs.sensor_measurement_15), -self.get_obs(self.obs.sensor_measurement_17)]
